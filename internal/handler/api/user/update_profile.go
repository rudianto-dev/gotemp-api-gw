...
func (s *UserHandler) UpdateProfile(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	request := userDomain.UpdateProfileRequest{}
	...
	resp, err := s.userUseCase.UpdateProfile(ctx, request)
	if err != nil {
